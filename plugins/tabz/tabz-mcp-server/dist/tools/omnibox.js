...
import { BACKEND_URL, setCurrentTabId } from "../shared.js";
/**
 ...
 */
function isAllowedUrl(url, settings) {
...
export function registerOmniboxTools(server) {
    // Open URL tool
    server.tool("tabz_open_url", `Open a URL in the browser.
...
Error Handling:
  ...
  - "Extension not available": Backend not running or extension not connected`, OpenUrlSchema.shape, async (params) => {
        try {
