...
export function registerInspectionTools(server) {
    server.tool("tabz_get_element", `Get detailed information about a DOM element for CSS debugging or recreation.
...
Error Handling:
  ...
  - "Cannot connect": Ensure TabzChrome extension is installed and backend is running at localhost:8129`, GetElementSchema.shape, async (params) => {
        try {
