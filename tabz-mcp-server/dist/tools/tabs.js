...
export function registerTabTools(server) {
    // List tabs tool
    server.tool("tabz_list_tabs", `List all open browser tabs with accurate active tab detection. Syncs Claude's target to user's focused tab.

Args: response_format (optional)`, ListTabsSchema.shape, async (params) => {
        try {
