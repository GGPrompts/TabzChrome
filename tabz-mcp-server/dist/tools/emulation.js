...
export function registerEmulationTools(server) {
    // Emulate Device
    server.tool("tabz_emulate_device", `Emulate mobile or tablet device viewport using Chrome DevTools Protocol.
...
Examples:
  ...
  - Custom: device="custom", width=400, height=800, deviceScaleFactor=2`, EmulateDeviceSchema.shape, async (params) => {
        try {
    ...
    // Clear Emulation
    server.tool("tabz_emulate_clear", `Clear all emulation overrides and detach the Chrome debugger.
...
Args:
  - tabId: Target tab (default: active tab)`, EmulateClearSchema.shape, async (params) => {
        try {
    ...
    // Emulate Geolocation
    server.tool("tabz_emulate_geolocation", `Override browser geolocation using Chrome DevTools Protocol.
...
Examples:
  ...
  - Clear override: clear=true`, EmulateGeolocationSchema.shape, async (params) => {
        try {
    ...
    // Emulate Network
    server.tool("tabz_emulate_network", `Throttle network speed using Chrome DevTools Protocol.
...
Examples:
  ...
  - Remove throttling: preset="no_throttle"`, EmulateNetworkSchema.shape, async (params) => {
        try {
    ...
    // Emulate Media
    server.tool("tabz_emulate_media", `Emulate CSS media type and features using Chrome DevTools Protocol.
...
Examples:
  ...
  - Reduced motion: reducedMotion="reduce"`, EmulateMediaSchema.shape, async (params) => {
        try {
    ...
    server.tool("tabz_emulate_vision", `Simulate vision deficiency using Chrome DevTools Protocol.
...
Examples:
  ...
  - Clear simulation: type="none"`, EmulateVisionSchema.shape, async (params) => {
        try {
