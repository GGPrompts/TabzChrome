...
import { SidebarProfileCards } from '../components/SidebarProfileCards'
              ...
              <div className="flex flex-col items-center h-full text-gray-400 pt-8 overflow-y-auto">
                ...
                {wsConnected ? (
                  <>
                    ...
                    {/* Pinned Profile Cards - Quick access to pinned profiles */}
                    ...
                    <a
                      ...
                      className="mt-6 text-xs text-gray-500 hover:text-[#00ff88] transition-colors flex items-center gap-1.5"
                    >
